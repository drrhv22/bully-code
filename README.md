...
**bully code** — a collection of twelve single-purpose skills for Claude Code (and any other LLM). Each does **one sharp job** in a **distinct voice**, and every one obeys the same rule:
...
```
/plugin marketplace add drrhv22/bully-code
```
