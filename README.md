...
A collection of nine single-purpose skills for Claude Code (and any other LLM). Each does **one sharp job** in a **distinct voice**, and every one obeys the same rule:
...
This repo is also a plugin marketplace — add it once and get all nine skills:
